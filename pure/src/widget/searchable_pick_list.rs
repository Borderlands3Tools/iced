...
impl<'a, T: 'a, Message, Renderer: text::Renderer>
    SearchablePickList<'a, T, Message, Renderer>
where
    T: ToString + Eq,
    [T]: ToOwned<Owned = Vec<T>>,
{
    /// The default padding of a [`SearchablePickList`].
    pub const DEFAULT_PADDING: Padding = Padding::new(5);

    /// Creates a new [`SearchablePickList`] with the given list of options, the current
    ...
    /// Sets the placeholder of the [`SearchablePickList`].
    ...
    /// Sets the font of the [`SearchablePickList`].
